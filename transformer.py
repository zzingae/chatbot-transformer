...
def get_decoder_self_attention_bias(length):
  ...
  with tf.name_scope("decoder_self_attention_bias"):
      # removed attention masking in decoder's self-attention
...
class MaskTransformer(Transformer):
  ...
  def decode(self, targets, encoder_outputs, attention_bias):
    ...
    with tf.name_scope("decode"):
      ...
      # decoder_self_attention_bias: target 의 padding과 mask 된 부분을 masking (decoder-decoder self-attention 시 사용)
      # attention_bias: input 의 padding 부분을 masking (encoder-decoder attention 시 사용)
      decoder_self_attention_bias = model_utils.get_padding_bias(targets)
